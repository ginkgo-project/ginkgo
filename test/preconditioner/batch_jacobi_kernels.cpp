...
//     auto mat =
//         gko::share(gko::test::generate_3pt_stencil_batch_matrix<const
//         CsrMtx>(
//             exec, num_batch_items, num_rows, (3 * num_rows - 2)));
//     auto linear_system = setup_linsys_and_solver(mat, num_rhs, tol,
//     max_iters); auto precond_solver =
...
//     std::shared_ptr<Logger> logger = Logger::create();
//     auto mat =
//         gko::share(gko::test::generate_diag_dominant_batch_matrix<const
//         CsrMtx>(
