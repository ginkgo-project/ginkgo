...
//     template <typename ValueType = value_type, typename IndexType =
//     index_type> std::unique_ptr<Dense<ValueType>> gen_mtx(int num_rows, int
//     num_cols)
//     {
//         return gko::test::generate_random_matrix<Dense<ValueType>>(
//             num_rows, num_cols,
//             std::uniform_int_distribution<IndexType>(num_cols, num_cols),
//             std::normal_distribution<ValueType>(-1.0, 1.0), rand_engine,
//             ref);
//     }
...
//         d_residual_norm_collection = gko::clone(exec,
//         residual_norm_collection); d_givens_sin = gko::clone(exec,
//         givens_sin); d_givens_cos = gko::clone(exec, givens_cos);
//         d_stop_status = gko::array<gko::stopping_status>(exec, stop_status);
//         d_final_iter_nums = gko::array<gko::size_type>(exec,
//         final_iter_nums);
//     }
...
//     GKO_ASSERT_MTX_NEAR(d_residual_norm, residual_norm,
//     r<value_type>::value); GKO_ASSERT_MTX_NEAR(d_residual_norm_collection,
//     residual_norm_collection,
//                         r<value_type>::value);
...
//         exec, d_givens_sin->get_device_view(),
//         d_givens_cos->get_device_view(), d_residual_norm->get_device_view(),
//         d_residual_norm_collection->get_device_view(),
...
//         ref, krylov_bases->get_const_device_view(),
//         y->get_const_device_view(), before_preconditioner->get_device_view(),
...
//         gko::span{0, x->get_size()[0] *
//         gko::solver::gmres_default_krylov_dim}, gko::span{0,
//         x->get_size()[1]});
//     auto d_krylov_basis = d_krylov_bases->create_submatrix(
//         gko::span{0,
//                   d_x->get_size()[0] *
//                   gko::solver::gmres_default_krylov_dim},
