          ...
          local_result{
              {{local_size,
                {{0, 0, 2},    {0, 1, -1}, {0, 3, -1},   {1, 0, -1},
                 ...
                 {4, 5, -0.5}, {5, 2, -1}, {5, 4, -0.5}, {5, 5, 1.5}}},
               {local_size,
                {{4, 4, 1.5},  {4, 0, -0.5}, {4, 2, -1},   {0, 4, -0.5},
                 {0, 0, 2},    {0, 1, -0.4}, {0, 3, -1},   {1, 0, -0.5},
                 {1, 1, 1.5},  {1, 5, -1},   {2, 3, -1},   {2, 2, 1.5},
                 {2, 3, -0.5}, {3, 0, -1},   {3, 2, -0.5}, {3, 3, 2},
                 {3, 5, -0.5}, {5, 1, -1},   {5, 3, -0.5}, {5, 5, 1.5}}},
               {local_size,
                {{4, 4, 1.5}, {4, 5, -0.5}, {4, 1, -1}, {5, 4, -0.5},
                 {5, 5, 2},   {5, 0, -0.5}, {5, 2, -1}, {0, 5, -0.5},
                 {0, 0, 1.5}, {0, 3, -1},   {1, 4, -1}, {1, 1, 2},
                 {1, 2, -1},  {2, 5, -1},   {2, 1, -1}, {2, 2, 3},
                 {2, 3, -1},  {3, 0, -1},   {3, 2, -1}, {3, 3, 2}}}}},
          engine(42)
    {
...
TYPED_TEST(MatrixCreation, ReadsDistributed)
{
...
//                 exec,
//                 I<gko::experimental::distributed::comm_index_type>{1, 1, 2,
//                 0,
//                                                                    0}),
//             3);
...
//         this->col_part); csr_mat->read(mat_input);
...
//     void assert_local_vector_equal_to_global_vector(const dist_vec_type*
//     dist,
//                                                     const dense_vec_type*
//                                                     dense, const part_type*
//                                                     part, int rank)
//     {
