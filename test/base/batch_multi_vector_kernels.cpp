...
//     using NormVector =
//     gko::batch::MultiVector<gko::remove_complex<value_type>>; using
//     ComplexMtx = gko::batch::MultiVector<std::complex<value_type>>;
...
//     void set_up_vector_data(gko::size_type num_vecs, const int num_rows =
//     252,
...
//     auto norm_size =
//         gko::batch_dim<2>(batch_size, gko::dim<2>{1,
//         x->get_common_size()[1]});
...
//     GKO_ASSERT_BATCH_MTX_NEAR(norm_expected, dnorm, 5 *
//     r<value_type>::value);
// }
...
//     GKO_ASSERT_BATCH_MTX_NEAR(cdot_expected, dc_dot, 5 *
//     r<value_type>::value);
// }
