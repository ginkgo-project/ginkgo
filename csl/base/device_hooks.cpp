...
#define GKO_STUB_VALUE_TYPE_EXCEPT_FLOAT(_macro)         \
    template <typename ValueType>                        \
    _macro(ValueType) GKO_NOT_COMPILED(GKO_HOOK_MODULE); \
    GKO_INSTANTIATE_FOR_EACH_VALUE_TYPE_EXCEPT_FLOAT(_macro)
...
GKO_STUB_VALUE_TYPE_EXCEPT_FLOAT(GKO_DECLARE_DENSE_SIMPLE_APPLY_KERNEL);
