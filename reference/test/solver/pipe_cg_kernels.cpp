...
TYPED_TEST(PipeCg, KernelInitialize2)
{
    ...
    gko::kernels::reference::pipe_cg::initialize_2(
        ...
        this->small_q->get_device_view(), this->small_f->get_device_view(),
        this->small_g->get_device_view(), this->small_beta->get_device_view(),
        this->small_z1->get_const_device_view(),
        this->small_w->get_const_device_view(),
        this->small_m->get_const_device_view(),
        this->small_n->get_const_device_view(),
        this->small_delta->get_const_device_view());
...
TYPED_TEST(PipeCg, KernelStep1)
{
    ...
    gko::kernels::reference::pipe_cg::step_1(
        ...
        this->small_r->get_device_view(), this->small_z1->get_device_view(),
        this->small_z2->get_device_view(), this->small_w->get_device_view(),
...
TYPED_TEST(PipeCg, KernelStep2)
{
    ...
    gko::kernels::reference::pipe_cg::step_2(
        this->exec, this->small_beta->get_device_view(),
        this->small_p->get_device_view(), this->small_q->get_device_view(),
        this->small_f->get_device_view(), this->small_g->get_device_view(),
        this->small_z1->get_const_device_view(),
        this->small_w->get_const_device_view(),
        this->small_m->get_const_device_view(),
        this->small_n->get_const_device_view(),
...
TYPED_TEST(PipeCg, SolvesBigMultiVectorSystem1)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
...
TYPED_TEST(PipeCg, SolvesBigMultiVectorSystem2)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
...
TYPED_TEST(PipeCg, SolvesBigMultiVectorSystem3)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
...
TYPED_TEST(PipeCg, SolvesMultipleMultiVectorSystemForDivergenceCheck)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
...
TYPED_TEST(PipeCg, SolvesTransposedBigMultiVectorSystem)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
...
TYPED_TEST(PipeCg, SolvesConjTransposedBigMultiVectorSystem)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
