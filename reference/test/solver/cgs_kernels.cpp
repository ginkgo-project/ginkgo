...
TYPED_TEST(Cgs, KernelInitialize)
{
    ...
    gko::kernels::reference::cgs::initialize(
        ...
        this->small_r->get_device_view(), this->small_r_tld->get_device_view(),
        this->small_p->get_device_view(), this->small_q->get_device_view(),
        this->small_u->get_device_view(), this->small_u_hat->get_device_view(),
        this->small_v_hat->get_device_view(), this->small_t->get_device_view(),
...
TYPED_TEST(Cgs, KernelStep1)
{
    ...
    gko::kernels::reference::cgs::step_1(
        ...
        this->small_u->get_device_view(), this->small_p->get_device_view(),
...
TYPED_TEST(Cgs, KernelStep2)
{
    ...
    gko::kernels::reference::cgs::step_2(
        this->exec, this->small_u->get_const_device_view(),
        this->small_v_hat->get_const_device_view(),
        this->small_q->get_device_view(), this->small_t->get_device_view(),
        this->small_alpha->get_device_view(),
        this->small_rho->get_const_device_view(),
        this->small_gamma->get_const_device_view(), this->small_stop);
...
TYPED_TEST(Cgs, KernelStep3)
{
    ...
    gko::kernels::reference::cgs::step_3(
        this->exec, this->small_t->get_const_device_view(),
        this->small_u_hat->get_const_device_view(),
        this->small_r->get_device_view(), this->small_x->get_device_view(),
        this->small_alpha->get_const_device_view(), this->small_stop);
