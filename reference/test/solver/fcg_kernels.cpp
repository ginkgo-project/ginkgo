...
TYPED_TEST(Fcg, KernelInitialize)
{
    ...
    gko::kernels::reference::fcg::initialize(
        ...
        this->small_t->get_device_view(),
        this->small_prev_rho->get_device_view(),
        this->small_rho->get_device_view(),
        this->small_rho_t->get_device_view(), this->small_stop);
...
TYPED_TEST(Fcg, KernelStep1)
{
    ...
    gko::kernels::reference::fcg::step_1(
        ...
        this->small_rho_t->get_const_device_view(),
...
TYPED_TEST(Fcg, KernelStep2)
{
    ...
    gko::kernels::reference::fcg::step_2(
        ...
        this->small_r->get_device_view(), this->small_t->get_device_view(),
...
TYPED_TEST(Fcg, SolvesBigMultiVectorSystem1)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
...
TYPED_TEST(Fcg, SolvesBigMultiVectorSystemWithImplicitResNormCrit)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
...
TYPED_TEST(Fcg, SolvesBigMultiVectorSystem2)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
...
TYPED_TEST(Fcg, SolvesMultipleBigMultiVectorSystems)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
...
TYPED_TEST(Fcg, SolvesTransposedBigMultiVectorSystem)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
...
TYPED_TEST(Fcg, SolvesConjTransposedBigMultiVectorSystem)
{
    using Mtx = typename TestFixture::Mtx;
    using value_type = typename TestFixture::value_type;
    // the system is already out of half precision range
