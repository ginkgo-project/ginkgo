    ...
    if(DEFINED ${deprecated})
        if(DEFINED ${actual})
            ...
            if("${${actual}}" STREQUAL "${${deprecated}}")
                ...
                message(
                    WARNING
                        "${deprecated} was deprecated, please only use ${actual} instead. We removed the old variable."
                )
                ...
                message(
                    FATAL_ERROR
                        "Both ${deprecated} and ${actual} were specified differently, please only use ${actual} instead."
                )
            endif()
        else()
            ...
            message(
                WARNING
                    "${deprecated} was deprecated, please use ${actual} instead.  "
                    "We copied ${${deprecated}} to ${actual} and removed the old variable."
            )
            set(${actual}
                ${${deprecated}}
                CACHE ${type} "${doc_string}"
            )
            unset(${deprecated} CACHE)
        endif()
    endif()
