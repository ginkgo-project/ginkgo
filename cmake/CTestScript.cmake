...
if (DEFINED GINKGO_SONARQUBE_TEST)
    set(CTEST_BUILD_COMMAND "build-wrapper-linux-x86-64 --out-dir bw-output make")
endif()
ctest_build(BUILD "${CTEST_BINARY_DIRECTORY}" APPEND CAPTURE_CMAKE_ERROR FIRST_BUILD)
