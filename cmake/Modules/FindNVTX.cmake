...
if(NOT NVTX3_INCLUDE_DIR)
    ...
    find_package_handle_standard_args(
        NVTX
        REQUIRED_VARS NVTX_LIBRARY NVTX_INCLUDE_DIR
    )
else()
    ...
    if(NOT NVTX3_INCLUDE_DIR)
        ...
        if(NOT TARGET nvtx::nvtx)
            ...
            set_target_properties(
                nvtx::nvtx
                PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${NVTX_INCLUDE_DIRS}"
            )
            set_target_properties(
                nvtx::nvtx
                PROPERTIES INTERFACE_COMPILE_DEFINITIONS GKO_LEGACY_NVTX
            )
        ...
        if(NOT TARGET nvtx::nvtx)
            ...
            if(WIN32)
                ...
                set_target_properties(
                    nvtx::nvtx
                    PROPERTIES INTERFACE_COMPILE_DEFINITIONS NOMINMAX
                )
            endif()
        endif()
    endif()
