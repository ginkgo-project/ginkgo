...
if(HWLOC_INCLUDE_DIRS)
    ...
    if(NOT HWLOC_VERSION)
        file(READ "${HWLOC_INCLUDE_DIRS}/hwloc.h" HEADER_CONTENTS LIMIT 16384)
        string(
            REGEX REPLACE
            ".*#define HWLOC_API_VERSION (0[xX][0-9a-fA-F]+).*"
            "\\1"
            HWLOC_API_VERSION
            "${HEADER_CONTENTS}"
        )
...
if(HWLOC_INCLUDE_DIRS AND HWLOC_LIBRARIES)
    ...
    set(hwloc_err_msg
        "${Magenta}Looking for HWLOC - not found
...
if(HWLOC_INCLUDE_DIRS AND HWLOC_LIBRARIES)
    ...
    if(HWLOC_VERSION VERSION_LESS HWLOC_FIND_VERSION)
        message(
            STATUS
            "Required version ${HWLOC_FIND_VERSION}, but found version ${HWLOC_VERSION}"
        )
...
if(HWLOC_FOUND AND NOT TARGET hwloc)
    ...
    set_target_properties(
        hwloc
        PROPERTIES INTERFACE_LINK_LIBRARIES ${HWLOC_LIBRARIES}
    )
    set_target_properties(
        hwloc
