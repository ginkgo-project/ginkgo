...
function(ginkgo_create_hip_test_internal test_name filename test_target_name additional_flags)
    ...
    set(GINKGO_TEST_HIP_DEFINES -DGKO_COMPILING_HIP -DGKO_DEVICE_NAMESPACE=hip ${additional_flags})
    if (GINKGO_FAST_TESTS)
...
function(ginkgo_create_common_device_test test_name)
    ...
    if(GINKGO_BUILD_HIP)
        ...
        ginkgo_create_hip_test_internal(${test_name}_hip ${CMAKE_CURRENT_BINARY_DIR}/${test_name}.hip.cpp ${test_target_name}_hip "-std=c++14;-DEXEC_TYPE=HipExecutor;-DGKO_DEVICE_NAMESPACE=hip" ${ARGN})
    endif()
