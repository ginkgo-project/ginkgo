...
function(ginkgo_create_common_test test_name)
    cmake_parse_arguments(PARSE_ARGV 1 common_test "" "" "DISABLE_EXECUTORS;ADDITIONAL_LIBRARIES;TIMEOUT")
    set(executors)
    if(GINKGO_BUILD_OMP)
    ...
    foreach(exec ${executors})
        ...
        if(NOT ("${common_test_TIMEOUT}" STREQUAL ""))
            file(RELATIVE_PATH REL_BINARY_DIR ${PROJECT_BINARY_DIR} ${CMAKE_CURRENT_BINARY_DIR})
            set_tests_properties(${REL_BINARY_DIR}/${test_name}_${exec} PROPERTIES TIMEOUT ${common_test_TIMEOUT}) 
        endif()
    endforeach()
