...
if(NOT DEFINED GINKGO_BUILD_DPCPP AND NOT DEFINED GINKGO_BUILD_SYCL)
    try_compile(
        GKO_CAN_COMPILE_DPCPP ${PROJECT_BINARY_DIR}/dpcpp
        SOURCES ${PROJECT_SOURCE_DIR}/dpcpp/test_dpcpp.dp.cpp
        # try_compile will pass the project CMAKE_CXX_FLAGS so passing
        # -DCMAKE_CXX_FLAGS does not affect it. They append COMPILE_DEFINITIONS
        # into CMAKE_CXX_FLAGS. Note. it is different from try_compile
        # COMPILE_DEFINITIONS affect
        CMAKE_FLAGS -DCOMPILE_DEFINITIONS=-fsycl CXX_STANDARD 17
    )
