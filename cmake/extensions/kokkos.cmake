...
function(ginkgo_internal_setup_kokkos target sources)
    ...
    if (Kokkos_ENABLE_HIP)
        ...
        foreach (source ${sources})
            set_source_files_properties(${source} PROPERTIES LANGUAGE HIP HIP_ARCHITECTURES ${CMAKE_HIP_ARCHITECTURES})
        endforeach ()
    endif ()
    if (Kokkos_ENABLE_CUDA)
...
function(ginkgo_add_kokkos_executable target)
    add_executable(${target} "${ARGN}")
    ginkgo_internal_setup_kokkos(${target} "${ARGN}")
endfunction()


function(ginkgo_add_kokkos_library target)
