...
public:
     ...
     */
    constexpr SimpleRelResidual(const real_type rel_res_tol,
     ...
     */
    constexpr bool check_converged(const real_type* const residual_norms) const
    {
...
public:
     ...
     */
    constexpr SimpleAbsResidual(const real_type tol, const real_type*)
        : abs_tol_{tol}
    {}
