...
// @subsection gUDcDz Include files
...
int main(int argc, char* argv[])
{
    ...
    // @subsection UIIyVg Where do you want to run your solver ?
    ...
    // @subsection IkqJIB Reading your data and transfer to the proper device.
    ...
    // @subsection eYKbtp Creating the solver
