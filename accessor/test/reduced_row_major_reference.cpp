...
public:
    ...
    using ref_type = acc::reference_class::reduced_storage<ar_type, st_type>;
    using const_ref_type =
        acc::reference_class::reduced_storage<ar_type, const st_type>;
...
public:
    ...
    using st_type =
        typename std::tuple_element<1, decltype(ArithmeticStorageType{})>::type;
    using rc_ar_type = acc::remove_complex_t<ar_type>;
    using rc_st_type = acc::remove_complex_t<st_type>;
    using ref_type = acc::reference_class::reduced_storage<ar_type, st_type>;
    using const_ref_type =
        acc::reference_class::reduced_storage<ar_type, const st_type>;
