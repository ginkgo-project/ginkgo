...
#ifndef GKO_PUBLIC_CORE_FACTORIZATION_ILUT_HPP_
#define GKO_PUBLIC_CORE_FACTORIZATION_ILUT_HPP_
...
/**
 * ILUT is an incomplete threshold-based LU factorization.
 *
 ...
 * factorization of $A$.
 *
 * One iteration of the ILUT algorithm consists of the following steps:
 *
 ...
 *    residual value.
 * 3. Performing an incomplete factorization on the new sparsity pattern.
 * 4. Removing the smallest entries (by magnitude) from $L$ and $U$
 * 5. ?? TODO
 *
 * This ILUT algorithm thus improves the sparsity pattern and the
...
class Ilut : public Composition<ValueType> {
public:
    ...
    {
        /**
         * The number of total iterations of ILUT that will be executed.
         * The default value is 1.
         */
        size_type GKO_FACTORY_PARAMETER_SCALAR(iterations, 1);
    ...
    GKO_ENABLE_LIN_OP_FACTORY(Ilut, parameters, Factory);
...
protected:
    explicit Ilut(const Factory* factory,
...
#endif  // GKO_PUBLIC_CORE_FACTORIZATION_ILUT_HPP_
