...
#define GKO_DECLARE_ALL_AS_TEMPLATES(_export_macro)                         \
    ...
    _export_macro GKO_DECLARE_BATCH_DENSE_SIMPLE_APPLY_KERNEL(ValueType);   \
    template <typename ValueType>                                           \
    _export_macro GKO_DECLARE_BATCH_DENSE_ADVANCED_APPLY_KERNEL(ValueType); \
    template <typename ValueType>                                           \
    _export_macro GKO_DECLARE_BATCH_DENSE_SCALE_KERNEL(ValueType);          \
    template <typename ValueType>                                           \
    _export_macro GKO_DECLARE_BATCH_DENSE_SCALE_ADD_KERNEL(ValueType);      \
    template <typename ValueType>                                           \
    _export_macro GKO_DECLARE_BATCH_DENSE_ADD_SCALED_IDENTITY_KERNEL(       \
        ValueType)
