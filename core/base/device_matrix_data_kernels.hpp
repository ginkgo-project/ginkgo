...
#define GKO_DECLARE_ALL_AS_TEMPLATES(_export_macro)                            \
    ...
    _export_macro GKO_DECLARE_DEVICE_MATRIX_DATA_SOA_TO_AOS_KERNEL(ValueType,  \
                                                                   IndexType); \
    template <typename ValueType, typename IndexType>                          \
    _export_macro GKO_DECLARE_DEVICE_MATRIX_DATA_AOS_TO_SOA_KERNEL(ValueType,  \
                                                                   IndexType); \
    template <typename ValueType, typename IndexType>                          \
    _export_macro GKO_DECLARE_DEVICE_MATRIX_DATA_REMOVE_ZEROS_KERNEL(          \
        ValueType, IndexType);                                                 \
    template <typename ValueType, typename IndexType>                          \
    _export_macro GKO_DECLARE_DEVICE_MATRIX_DATA_SUM_DUPLICATES_KERNEL(        \
        ValueType, IndexType);                                                 \
    template <typename ValueType, typename IndexType>                          \
    _export_macro GKO_DECLARE_DEVICE_MATRIX_DATA_SORT_ROW_MAJOR_KERNEL(        \
        ValueType, IndexType)
