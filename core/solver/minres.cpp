                                         ...
                                         VectorType* dense_x) const
{
    ...
    // this is the approximation of the residual norm, it is set to ||z||, but
    // it could also use beta or ||r||
    auto tau =
        this->template create_workspace_scalar<typename NormVector::value_type>(
            GKO_SOLVER_TRAITS::tau, dense_b->get_size()[1]);
    ...
    z->compute_norm2(tau, reduction_tmp);
