...
#define GKO_DECLARE_ALL_AS_TEMPLATES(_export_macro)                \
    ...
    _export_macro GKO_DECLARE_MINRES_INITIALIZE_KERNEL(ValueType); \
    template <typename ValueType>                                  \
    _export_macro GKO_DECLARE_MINRES_STEP_1_KERNEL(ValueType);     \
    template <typename ValueType>                                  \
    _export_macro GKO_DECLARE_MINRES_STEP_2_KERNEL(ValueType)
