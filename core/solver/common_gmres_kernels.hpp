...
#define GKO_DECLARE_ALL_AS_TEMPLATES(_export_macro)                         \
    ...
    _export_macro GKO_DECLARE_COMMON_GMRES_INITIALIZE_KERNEL(ValueType);    \
    template <typename ValueType>                                           \
    _export_macro GKO_DECLARE_COMMON_GMRES_HESSENBERG_QR_KERNEL(ValueType); \
    template <typename ValueType>                                           \
    _export_macro GKO_DECLARE_COMMON_GMRES_SOLVE_KRYLOV_KERNEL(ValueType)
