...
#define GKO_STUB_CB_GMRES_F(_macro)                                      \
    template <typename ValueType, typename FrszCompressor>               \
    _macro(ValueType, FrszCompressor) GKO_NOT_COMPILED(GKO_HOOK_MODULE); \
    GKO_INSTANTIATE_FOR_EACH_CB_GMRES_F_TYPE(_macro)
...
GKO_STUB_CB_GMRES_F(GKO_DECLARE_CB_GMRES_RESTART_F_KERNEL);
GKO_STUB_CB_GMRES_F(GKO_DECLARE_CB_GMRES_ARNOLDI_F_KERNEL);
GKO_STUB_CB_GMRES_F(GKO_DECLARE_CB_GMRES_SOLVE_KRYLOV_F_KERNEL);
