...
GKO_STUB_BATCH_VALUE_MATRIX_PRECONDITIONER_BASE(
    ...
    GKO_EXPORT_HOOK GKO_DECLARE_BATCH_BICGSTAB_APPLY_KERNEL_WRAPPER);
...
GKO_STUB_BATCH_VALUE_MATRIX_PRECONDITIONER_BASE(
    ...
    GKO_EXPORT_HOOK GKO_DECLARE_BATCH_CG_APPLY_KERNEL_WRAPPER);
...
GKO_STUB_CB_GMRES(GKO_EXPORT_HOOK GKO_DECLARE_CB_GMRES_RESTART_KERNEL);
GKO_STUB_CB_GMRES(GKO_EXPORT_HOOK GKO_DECLARE_CB_GMRES_ARNOLDI_KERNEL);
GKO_STUB_CB_GMRES_CONST(
