...
GKO_STUB_INDEX_TYPE(GKO_DECLARE_MAX_ARRAY_KERNEL);
GKO_STUB_INDEX_TYPE(GKO_DECLARE_MIN_ARRAY_KERNEL);
...
GKO_STUB_MIXED_VALUE_AND_INDEX_TYPE_2(GKO_DECLARE_DENSE_ROW_SCATTER_KERNEL);
GKO_STUB_MIXED_VALUE_AND_INDEX_TYPE_2(
