...
GKO_STUB_MIXED_VALUE_AND_INDEX_TYPE(GKO_DECLARE_AMP_SPMV_KERNEL);
GKO_STUB_MIXED_VALUE_AND_INDEX_TYPE(GKO_DECLARE_AMP_ADVANCED_SPMV_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_AMP_FILL_IN_DENSE_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_AMP_GENERATE_CWISE_ELL_STEP1_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_AMP_GENERATE_ELL_SCATTER_BINS_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_AMP_EXTRACT_DIAGONAL_KERNEL);
