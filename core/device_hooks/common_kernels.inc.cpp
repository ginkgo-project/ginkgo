...
GKO_STUB_NON_COMPLEX_VALUE_AND_INDEX_TYPE(GKO_DECLARE_GENERATE_CONSTRAINTS);
GKO_STUB_VALUE_TYPE(GKO_DECLARE_FILL_COARSE_DATA);
GKO_STUB_VALUE_TYPE(GKO_DECLARE_BUILD_COARSE_CONTRIBUTION);
