...
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_CHOLESKY_SYMBOLIC_POSTORDER);
...
GKO_STUB_INDEX_TYPE(GKO_DECLARE_ELIMINATION_FOREST_COMPUTE_CHILDREN);
...
GKO_STUB_INDEX_TYPE(GKO_DECLARE_ELIMINATION_FOREST_COMPUTE_LEVELS);
GKO_STUB_INDEX_TYPE(GKO_DECLARE_ELIMINATION_FOREST_COMPUTE_POSTORDER);
GKO_STUB_INDEX_TYPE(GKO_DECLARE_ELIMINATION_FOREST_COMPUTE_EULER_PATH);
GKO_STUB_INDEX_TYPE(GKO_DECLARE_ELIMINATION_FOREST_MAP_POSTORDER);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_ELIMINATION_FOREST_FROM_FACTOR);
GKO_STUB_INDEX_TYPE(GKO_DECLARE_ELIMINATION_FOREST_POINTER_DOUBLE);
...
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_IC_INITIALIZE);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_IC_FACTORIZE);
