...
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_HMIS_COMPUTE_STRENGTH_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_HMIS_RUGE_STUEBEN_FIRST_PASS_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_HMIS_PMIS_COARSEN_KERNEL);
GKO_STUB_INDEX_TYPE(GKO_DECLARE_HMIS_BUILD_CPOINT_MAP_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_HMIS_BUILD_PROLONGATION_KERNEL);
