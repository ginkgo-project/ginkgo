...
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_SEPARATE_LOCAL_NONLOCAL_COLUMNS);
...
// no GKO_STUB_* macro for non-complex value + local/global index
template <typename ValueType, typename LocalIndexType, typename GlobalIndexType>
GKO_DECLARE_PMIS_INITIALIZE_WEIGHT_AND_STATUS_KERNEL(ValueType, LocalIndexType,
                                                     GlobalIndexType)
GKO_NOT_COMPILED(GKO_HOOK_MODULE);
...
GKO_STUB_INDEX_TYPE(GKO_DECLARE_PMIS_ADD_AT_INDICES);
GKO_STUB_VALUE_AND_LOCAL_GLOBAL_INDEX_TYPE_BASE(
    GKO_DECLARE_PMIS_CLASSIFY_SELECT_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_PMIS_CLASSIFY_MARK_FINE_KERNEL);
GKO_STUB(GKO_DECLARE_COUNT_KERNEL);
GKO_STUB(GKO_DECLARE_PMIS_CLASSIFY_SEED_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_DIRECT_INTERPOLATION_ROW_COUNT);
GKO_STUB_LOCAL_GLOBAL_TYPE(GKO_DECLARE_PMIS_COARSE_GLOBAL_INDEX);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_DIRECT_INTERPOLATION_ACCUMULATE);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_DIRECT_INTERPOLATION_EMIT);
GKO_STUB_VALUE_AND_INDEX_TYPE(
...
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_RS_CHECK_M_MATRIX_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_RS_COMPUTE_SOC_AND_RUN_RS_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(
    GKO_DECLARE_RS_FILL_COARSE_AND_COMPUTE_PROLONG_ROW_PTRS_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_RS_COMPUTE_INTERPOLATION_KERNEL);
