...
GKO_EXPORT GKO_DECLARE_MC64_INITIALIZE_WEIGHTS(ValueType, IndexType);

template <typename ValueType, typename IndexType>
GKO_EXPORT GKO_DECLARE_MC64_INITIAL_MATCHING(ValueType, IndexType);

template <typename ValueType, typename IndexType>
GKO_EXPORT GKO_DECLARE_MC64_SHORTEST_AUGMENTING_PATH(ValueType, IndexType);

template <typename ValueType, typename IndexType>
GKO_EXPORT GKO_DECLARE_MC64_COMPUTE_SCALING(ValueType, IndexType);
