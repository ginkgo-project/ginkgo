...
where {\ttfamily path/to/test} is the path returned by {\ttfamily make test}.\hypertarget{testing_ginkgo_autotoc_md10}{}\doxysubsubsection{Using C\+Test}\label{testing_ginkgo_autotoc_md10}
