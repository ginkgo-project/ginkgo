\hypertarget{testing_ginkgo_autotoc_md3}{}\doxysubsection{Running the unit tests}\label{testing_ginkgo_autotoc_md3}
You need to compile ginkgo with {\ttfamily -\/D\+G\+I\+N\+K\+G\+O\+\_\+\+B\+U\+I\+L\+D\+\_\+\+T\+E\+S\+TS=ON} option to be able to run the tests.\hypertarget{testing_ginkgo_autotoc_md4}{}\doxysubsubsection{Using make test}\label{testing_ginkgo_autotoc_md4}
...
where {\ttfamily path/to/test} is the path returned by {\ttfamily make test}.\hypertarget{testing_ginkgo_autotoc_md5}{}\doxysubsubsection{Using C\+Test}\label{testing_ginkgo_autotoc_md5}
