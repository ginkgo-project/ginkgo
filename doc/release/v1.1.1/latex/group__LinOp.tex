...
\begin{DoxyCompactList}\small\item\em A module dedicated to the implementation and usage of the Jacobi Preconditioner in Ginkgo. \end{DoxyCompactList}\item 
