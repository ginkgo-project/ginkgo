...
\DoxyCodeLine{    \textcolor{keyword}{using} mtx = \mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<>}};}
...
\DoxyCodeLine{              << 1.0 * time.count() / std::nano::den << \textcolor{stringliteral}{" seconds."} << std::endl}
\DoxyCodeLine{              << \textcolor{stringliteral}{"\(\backslash\)tAverage library overhead:     "}}
\DoxyCodeLine{              << 1.0 * time.count() / num\_iters << \textcolor{stringliteral}{" [nanoseconds / iteration]"}}
