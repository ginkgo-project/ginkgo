...
\DoxyCodeLine{\textcolor{keyword}{using} RealSolverType = \mbox{\hyperlink{namespacegko_adfcb75c44f6b6c701989419c166f6e7e}{gko::remove\_complex<SolverType>}};}
...
\DoxyCodeLine{MPIR execution time [ms]: 14.2256}
\end{DoxyCode}
