...
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_adfcb75c44f6b6c701989419c166f6e7e}{gko::remove\_complex<SolverType>}} inner\_reduction\_factor = 1e-\/2;}
\end{DoxyCode}
...
\DoxyCodeLine{\textcolor{keyword}{auto} initres\_vec = gko::initialize<vec>(\{0.0\}, exec);}
...
\DoxyCodeLine{        .with\_criteria(\mbox{\hyperlink{classgko_1_1stop_1_1ResidualNormReduction}{gko::stop::ResidualNormReduction<SolverType>::build}}()}
...
\DoxyCodeLine{\textcolor{keyword}{auto} res\_vec = gko::initialize<vec>(\{0.0\}, exec);}
...
\DoxyCodeLine{MPIR execution time [ms]: 18.0933}
\end{DoxyCode}
