...
When using {\ttfamily H\+I\+P\+\_\+\+P\+L\+A\+T\+F\+O\+RM=hcc}, note that two {\ttfamily H\+IP} compilers can be set, the old {\ttfamily hcc} or since R\+O\+Cm 3.\+5, {\ttfamily clang}. On newer installations, {\ttfamily clang} should be set by default, but if encountering any problem try to manually set the {\ttfamily H\+IP} compiler to {\ttfamily clang}\+: 
\begin{DoxyCode}{0}
