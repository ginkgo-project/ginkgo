...
To manually configure the paths Ginkgo relies on the \href{https://xsdk.info/policies/}{\tt standard x\+S\+DK Installation policies} for all packages except {\ttfamily C\+AS} (as it is neither a library nor a header, it cannot be expressed through the {\ttfamily T\+PL} format)\+:
\begin{DoxyItemize}
