...
\begin{DoxyCode}{0}
\DoxyCodeLine{Running 1000000 iterations of the CG solver took a total of 1.62987 seconds.}
\DoxyCodeLine{    Average library overhead:     1629.87 [nanoseconds / iteration]}
\end{DoxyCode}
