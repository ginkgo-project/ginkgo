...
\DoxyCodeLine{\textcolor{keyword}{using} gmres = \mbox{\hyperlink{classgko_1_1solver_1_1Gmres}{gko::solver::Gmres<>}};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} par\_ilu\_fact = \mbox{\hyperlink{classgko_1_1factorization_1_1ParIlu}{gko::factorization::ParIlu<>::build}}().on(exec);}
\end{DoxyCode}
...
\DoxyCodeLine{    \mbox{\hyperlink{classgko_1_1preconditioner_1_1Ilu}{gko::preconditioner::Ilu<gko::solver::LowerTrs<>}},}
\DoxyCodeLine{                             \mbox{\hyperlink{classgko_1_1solver_1_1UpperTrs}{gko::solver::UpperTrs<>}}, \textcolor{keyword}{false}>::build()}
...
\DoxyCodeLine{    \mbox{\hyperlink{classgko_1_1solver_1_1Gmres}{gko::solver::Gmres<>::build}}()}
