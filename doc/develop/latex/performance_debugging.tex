...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{typename} ValueType>}
\DoxyCodeLine{\textcolor{keywordtype}{double} get\_norm(\textcolor{keyword}{const} vec<ValueType> *norm)}
\DoxyCodeLine{\{}
\DoxyCodeLine{    \textcolor{keywordflow}{return} \mbox{\hyperlink{namespacegko_a1beb80750459e4201aa9d882d2d074c3}{clone}}(norm-\/>get\_executor()-\/>get\_master(), norm)-\/>at(0, 0);}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{typename} ValueType>}
\DoxyCodeLine{\textcolor{keywordtype}{double} compute\_norm(\textcolor{keyword}{const} vec<ValueType> *b)}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{typename} ValueType>}
\DoxyCodeLine{\textcolor{keywordtype}{double} compute\_residual\_norm(\textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}} *system\_matrix,}
\DoxyCodeLine{                             \textcolor{keyword}{const} vec<ValueType> *b, \textcolor{keyword}{const} vec<ValueType> *x)}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void} print\_vector(\textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<>}} *vec)}
\DoxyCodeLine{\{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using} vtype = double;}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using} mtx = \mbox{\hyperlink{classgko_1_1matrix_1_1Csr}{gko::matrix::Csr<vtype>}};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using} solver = \mbox{\hyperlink{classgko_1_1solver_1_1Cg}{gko::solver::Cg<vtype>}};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using} preconditioner = \mbox{\hyperlink{classgko_1_1matrix_1_1IdentityFactory}{gko::matrix::IdentityFactory<vtype>}};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} reduction\_factor = 1e-\/8;}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} max\_iters = 2000u;}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} of\_name = \textcolor{stringliteral}{"log.txt"};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using} vec = \mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<vtype>}};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} b = utils::create\_vector<vtype>(exec, A-\/>get\_size()[0], 1.0);}
\DoxyCodeLine{\textcolor{keyword}{auto} x = utils::create\_vector<vtype>(exec, A-\/>get\_size()[0], 0.0);}
\end{DoxyCode}
...
\DoxyCodeLine{            \mbox{\hyperlink{classgko_1_1stop_1_1ResidualNormReduction}{gko::stop::ResidualNormReduction<vtype>::build}}()}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} res\_logger = std::make\_shared<loggers::ResidualLogger<vtype>>(}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{This is Ginkgo 1.0.0 (develop)}
\DoxyCodeLine{    running with core module 1.0.0 (develop)}
\DoxyCodeLine{    the reference module is  1.0.0 (develop)}
\DoxyCodeLine{    the OpenMP    module is  1.0.0 (develop)}
\DoxyCodeLine{    the CUDA      module is  not compiled}
