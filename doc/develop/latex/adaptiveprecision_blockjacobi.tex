...
\DoxyCodeLine{\}}
\DoxyCodeLine{\textcolor{keyword}{auto} x = \mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<>::create}}(exec);}
\DoxyCodeLine{\textcolor{keyword}{auto} b = \mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<>::create}}(exec);}
...
\DoxyCodeLine{                    .with\_reduction\_factor(static\_cast<ValueType>(1e-\/12))}
...
\DoxyCodeLine{\%\%MatrixMarket matrix \mbox{\hyperlink{namespacegko_ae749a5ea11a93c1bcc9158d9a6e9fb68af1f713c9e000f5d3f280adbd124df4f5}{array}} \mbox{\hyperlink{namespacegko_abcf6f4649ad47679a4e7768156b6dd32}{real}} general}
\DoxyCodeLine{1 1}
\DoxyCodeLine{2.8994e-\/11}
\DoxyCodeLine{CG iteration count:     8}
\DoxyCodeLine{CG execution time [ms]: 4.10581}
\end{DoxyCode}
