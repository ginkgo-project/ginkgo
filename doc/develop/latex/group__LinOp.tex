...
class \mbox{\hyperlink{classgko_1_1preconditioner_1_1Ilu}{gko\+::preconditioner\+::\+Ilu$<$ L\+Solver\+Type, U\+Solver\+Type, Reverse\+Apply, Index\+Type\+Par\+Ilu $>$}}
...
\DoxyCodeLine{        L-\/>apply(\mbox{\hyperlink{namespacegko_aa8cb4876b72e5e1036ea9575443c439b}{gko::lend}}(tmp), \mbox{\hyperlink{namespacegko_aa8cb4876b72e5e1036ea9575443c439b}{gko::lend}}(x));}
\DoxyCodeLine{        x-\/>add\_scaled(\mbox{\hyperlink{namespacegko_aa8cb4876b72e5e1036ea9575443c439b}{gko::lend}}(\mbox{\hyperlink{namespacegko_a0059e27f8f4bc348ff65c1e60caf47c8}{one}}), \mbox{\hyperlink{namespacegko_aa8cb4876b72e5e1036ea9575443c439b}{gko::lend}}(b));}
\DoxyCodeLine{        tmp-\/>copy\_from(\mbox{\hyperlink{namespacegko_aa8cb4876b72e5e1036ea9575443c439b}{gko::lend}}(x));}
\DoxyCodeLine{    \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{public}:                                                                      \(\backslash\)}
\DoxyCodeLine{    const \_parameters\_name\#\#\_type \&get\_\#\#\_parameters\_name() const            \(\backslash\)}
\DoxyCodeLine{    \{                                                                        \(\backslash\)}
\DoxyCodeLine{        return \_parameters\_name\#\#\_;                                          \(\backslash\)}
\DoxyCodeLine{    \}                                                                        \(\backslash\)}
\DoxyCodeLine{                                                                             \(\backslash\)}
\DoxyCodeLine{    class \_factory\_name                                                      \(\backslash\)}
\DoxyCodeLine{        : \mbox{\hyperlink{group__LinOp_ga24628d477cba68b31cea690572c51912}{public ::gko::EnableDefaultLinOpFactory}}<\_factory\_name, \_lin\_op,    \(\backslash\)}
\DoxyCodeLine{                                                  \_parameters\_name\#\#\_type> \{ \(\backslash\)}
\DoxyCodeLine{        friend class ::gko::EnablePolymorphicObject<\_factory\_name,           \(\backslash\)}
\DoxyCodeLine{                                                    \mbox{\hyperlink{classgko_1_1LinOpFactory}{::gko::LinOpFactory}}>;    \(\backslash\)}
\DoxyCodeLine{        friend class ::gko::enable\_parameters\_type<\_parameters\_name\#\#\_type,  \(\backslash\)}
\DoxyCodeLine{                                                   \_factory\_name>;           \mbox{\hyperlink{group__LinOp_ga24628d477cba68b31cea690572c51912}{\(\backslash\)}}}
\DoxyCodeLine{\mbox{\hyperlink{group__LinOp_ga24628d477cba68b31cea690572c51912}{        using ::gko::EnableDefaultLinOpFactory}}<                              \(\backslash\)}
\DoxyCodeLine{            \_factory\_name, \_lin\_op,                                          \(\backslash\)}
\DoxyCodeLine{            \_parameters\_name\#\#\_type>\mbox{\hyperlink{group__LinOp_ga24628d477cba68b31cea690572c51912}{::EnableDefaultLinOpFactory}};             \(\backslash\)}
\DoxyCodeLine{    \};                                                                       \mbox{\hyperlink{group__LinOp_ga24628d477cba68b31cea690572c51912}{\(\backslash\)}}}
\DoxyCodeLine{\mbox{\hyperlink{group__LinOp_ga24628d477cba68b31cea690572c51912}{    friend ::gko::EnableDefaultLinOpFactory}}<\_factory\_name, \_lin\_op,          \(\backslash\)}
\DoxyCodeLine{                                            \_parameters\_name\#\#\_type>;        \(\backslash\)}
\DoxyCodeLine{                                                                             \(\backslash\)}
\DoxyCodeLine{                                                                             \(\backslash\)}
\DoxyCodeLine{private:                                                                     \(\backslash\)}
\DoxyCodeLine{    \_parameters\_name\#\#\_type \_parameters\_name\#\#\_;                             \(\backslash\)}
\DoxyCodeLine{                                                                             \(\backslash\)}
