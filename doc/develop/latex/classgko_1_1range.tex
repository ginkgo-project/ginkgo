...
\end{DoxyEnumerate}\hypertarget{classgko_1_1range_autotoc_md65}{}\doxysubsubsection{Range operations}\label{classgko_1_1range_autotoc_md65}
...
\end{DoxyCode}
\hypertarget{classgko_1_1range_autotoc_md67}{}\doxysubsubsection{Caveats}\label{classgko_1_1range_autotoc_md67}
...
Aliasing the result range in {\ttfamily mmul} and {\ttfamily transpose} is not allowed. Constructs like {\ttfamily A = transpose(\+A)}, {\ttfamily A = mmul(\+A, A)}, or {\ttfamily A = mmul(\+A, A) + C} lead to undefined behavior. However, aliasing input arguments is allowed\+: {\ttfamily C = mmul(\+A, A)}, and even {\ttfamily C = mmul(\+A, A) + C} is valid code (in the last example, only pointwise operations are aliased). {\ttfamily C = mmul(A, A + C)} is not valid though.\hypertarget{classgko_1_1range_autotoc_md68}{}\doxysubsubsection{Examples}\label{classgko_1_1range_autotoc_md68}
