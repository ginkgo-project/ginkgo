...
Referenced by gko\+::matrix\+::\+Dense$<$ Value\+Type $>$\+::create\+\_\+submatrix(), gko\+::matrix\+::\+Sparsity$<$ Value\+Type, Index\+Type $>$\+::get\+\_\+num\+\_\+nonzeros(), gko\+::\+Combination$<$ Value\+Type $>$\+::get\+\_\+operators(), and gko\+::matrix\+::\+Csr$<$ Value\+Type, Index\+Type $>$\+::get\+\_\+strategy().
