...
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_adfcb75c44f6b6c701989419c166f6e7e}{gko::remove\_complex<ValueType>}} get\_norm(}
\DoxyCodeLine{    \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<ValueType>}} *norm)}
\DoxyCodeLine{\{}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    \textcolor{keywordflow}{return} std::real(cpu\_norm-\/>at(0, 0));}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\DoxyCodeLine{Recurrent vs \mbox{\hyperlink{namespacegko_abcf6f4649ad47679a4e7768156b6dd32}{real}} residual norm:}
