...
r32 = [speedup_df.loc[speedup_df.batch_size==32 ,'speedup1'].values[0],
       speedup_df.loc[speedup_df.batch_size==512 ,'speedup1'].values[0],
       speedup_df.loc[speedup_df.batch_size==8192 ,'speedup1'].values[0],
       speedup_df.loc[speedup_df.batch_size==32768 ,'speedup1'].values[0],
       speedup_df.loc[speedup_df.batch_size==131072,'speedup1'].values[0],
       ]
r256 = [speedup_df.loc[speedup_df.batch_size==32 ,'speedup1'].values[1],
       speedup_df.loc[speedup_df.batch_size==512 ,'speedup1'].values[1],
       speedup_df.loc[speedup_df.batch_size==8192,'speedup1'].values[1],
       speedup_df.loc[speedup_df.batch_size==32768,'speedup1'].values[1],
       speedup_df.loc[speedup_df.batch_size==131072,'speedup1'].values[1]]
r2048 = [speedup_df.loc[speedup_df.batch_size==32 ,'speedup1'].values[2],
       speedup_df.loc[speedup_df.batch_size==512 ,'speedup1'].values[2],
       speedup_df.loc[speedup_df.batch_size==8192,'speedup1'].values[2],
       speedup_df.loc[speedup_df.batch_size==32768,'speedup1'].values[2],
       speedup_df.loc[speedup_df.batch_size==131072,'speedup1'].values[2]]
...
fname = 'tridiag_batch_speedup.pdf'
