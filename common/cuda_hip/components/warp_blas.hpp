 ...
 */
template <int max_problem_size, typename Group, typename ValueType>
__device__ __forceinline__ void apply_gauss_jordan_transform_with_rhs(
    const Group& __restrict__ group, int32 key_row, int32 key_col,
 ...
 */
template <int max_problem_size, postprocess_transformation mod = and_return,
 ...
 */
template <int max_problem_size, typename Group, typename MatrixValueType,
