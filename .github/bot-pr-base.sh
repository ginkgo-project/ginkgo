...
FORMAT_HEADER_REGEX='^(benchmark|core|cuda|hip|include/ginkgo/core|omp|reference|dpcpp|common/unified|test/[^t].*|test/t[^e].*)/'
FORMAT_REGEX='^(common|examples|test/test_.*)/'
